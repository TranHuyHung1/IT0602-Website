app.directive('slickSlider', function() {
  ...
  .controller('myController', function($scope, $http, $window, $routeParams, $interval) {
    ...
    $scope.slides = [
      {
          text1: 'Best Style shirt',
          text2: 'The Hottest Trend',
          text3: 'Shirt',
      ...
      },
      {
          ...
          text2: 'Up To 50% Off',
          text3: 'Fisrt Purchase time',
          text4: 'Delivered to your door in just 1 week.',
...
$scope.fbslides = [
{ image: '/img/banner/Custormer1.png', feedback: 'Why this product is so good , better try more!', name: 'Bean Legit', date: '25/10/2023' },
{ image: '/img/banner/customer2.jpg', feedback: 'The first time try this product, this actually frking good guys!', name: 'Louis Huy ', date: '15/12/2023' },
{ image: '/img/banner/customer3.jpg', feedback: 'Highly recommended this shop, unique store!', name: 'Bob Johnson', date: '07/08/2023' },
{ image: '/img/banner/pa.png', feedback: 'Amazing Product!', name: 'Alice Brown', date: '13/02/2023' }
];
